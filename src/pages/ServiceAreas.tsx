          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="mt-12 p-8 bg-blue-50 rounded-2xl border border-blue-100">
                <h3 className="text-xl font-bold text-blue-900 mb-4">Don't see your city?</h3>
                <p className="text-blue-800 mb-6">We often travel outside our standard service area for larger installations. Give us a call to see if we can help you!</p>
                <a href={`tel:${PHONE_NUMBER_RAW}`} className="text-blue-600 font-black text-2xl flex items-center gap-2">
            ...
            <div className="bg-gray-100 rounded-2xl h-[500px] flex items-center justify-center overflow-hidden shadow-inner border border-gray-200">
              ...
              <div className="text-center p-8">
                <MapPin size={64} className="text-blue-600 mx-auto mb-4 opacity-50" />
