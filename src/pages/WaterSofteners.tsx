            ...
            <div className="lg:w-1/2">
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                  Water Softener <span className="text-blue-600">Installation</span> in San Antonio
                </h1>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-blue-600 font-bold uppercase tracking-wider mb-4">The Problem</h2>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Protect your water heater, dishwasher, and washing machine from scale damage.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <CheckCircle2 className="text-blue-400 mt-1 shrink-0" />
                  <div>
                    ...
                    <p className="text-blue-100">Soft water allows your water heater to run more efficiently, saving you money every month.</p>
                  </div>
                </li>
              </ul>
            </div>
