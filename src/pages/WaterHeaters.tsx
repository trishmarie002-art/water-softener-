            ...
            <div className="lg:w-1/2">
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                  Water Heater <span className="text-blue-600">Installation</span> & Replacement
                </h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-10 rounded-2xl border border-gray-100">
              <h4 className="text-2xl font-bold mb-4 text-blue-600">Traditional Tank Heaters</h4>
            ...
            <div className="bg-gray-50 p-10 rounded-2xl border border-gray-100">
              <h4 className="text-2xl font-bold mb-4 text-blue-600">Tankless Water Heaters</h4>
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="bg-blue-800 p-3 rounded-lg shrink-0"><Clock className="text-blue-400" size={24} /></div>
                  <div>
                    <h4 className="text-xl font-bold">Age Over 10 Years</h4>
                    <p className="text-blue-100">Most traditional heaters last 8-12 years. If yours is older, it's time to plan.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="bg-blue-800 p-3 rounded-lg shrink-0"><Zap className="text-blue-400" size={24} /></div>
                  <div>
                    <h4 className="text-xl font-bold">Rusty or Discolored Water</h4>
                    <p className="text-blue-100">This often indicates internal corrosion and a potential tank failure.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="bg-blue-800 p-3 rounded-lg shrink-0"><ShieldCheck className="text-blue-400" size={24} /></div>
                  <div>
                    <h4 className="text-xl font-bold">Strange Noises</h4>
                    <p className="text-blue-100">Popping or rumbling sounds are caused by sediment buildup at the bottom.</p>
                  </div>
                </div>
              </div>
            </div>
